...
import { DayFormat01 } from '@dhicn/helper/date-formatter'

export const DevicePressureTag = 'Pressure'
export const DeviceFlowTag = 'Flow'

export const autoRunStartTime = dayjs().add(-2).format(DayFormat01)
export const autoRunEndTime = dayjs().add(-2).format(DayFormat01)

export const alarmStartTime = dayjs().add(-7).format(DayFormat01)
export const alarmEndTime = dayjs().add(-0).format(DayFormat01)
