    ...
    return {
        ...
        async apiV1FileServerDeleteBucketsPost(
            ...
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiV1FileServerDeleteBucketsPost(
                    deleteBucketInput,
                    options,
                )
        ...
        async apiV1FileServerDeleteFilesPost(
            ...
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiV1FileServerDeleteFilesPost(
                    deleteFileInput,
                    options,
                )
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
        ...
        async apiV1FileServerFileDownloadGet(
            ...
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiV1FileServerFileDownloadGet(
                    bucket,
                    objectName,
                    signature,
                    options,
        ...
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiV1FileServerGetFileUploadPathGet(
                    bucket,
                    directory,
                    fileName,
                    accessProp,
